...
public class AdminPermissions {
    ...
    public static final String GAMEMODE_MODES_ADVENTURE = "nucleus.gamemode.modes.adventure";

    @PermissionMetadata(descriptionKey = "permission.gamemode.modes.creative", level = SuggestedLevel.ADMIN)
    public static final String GAMEMODE_MODES_CREATIVE = "nucleus.gamemode.modes.creative";

    @PermissionMetadata(descriptionKey = "permission.gamemode.modes.spectator", level = SuggestedLevel.ADMIN)
    public static final String GAMEMODE_MODES_SPECTATOR = "nucleus.gamemode.modes.spectator";

    @PermissionMetadata(descriptionKey = "permission.gamemode.modes.survival", level = SuggestedLevel.ADMIN)
    public static final String GAMEMODE_MODES_SURVIVAL = "nucleus.gamemode.modes.survival";
