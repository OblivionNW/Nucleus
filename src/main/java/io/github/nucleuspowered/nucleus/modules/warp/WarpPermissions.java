...
public class WarpPermissions {
    ...
    public static final String BASE_CATEGORY_REMOVEDESCRIPTION = "nucleus.warp.category.description.base";

    @PermissionMetadata(descriptionKey = "permission.base", replacements = { "category removedisplayname" }, level = SuggestedLevel.ADMIN)
    public static final String BASE_CATEGORY_REMOVEDISPLAYNAME = "nucleus.warp.category.displayname.base";
