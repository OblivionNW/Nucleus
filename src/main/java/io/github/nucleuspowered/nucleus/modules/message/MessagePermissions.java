...
public class MessagePermissions {
    ...
    public static final String BASE_REPLY = "nucleus.message.base";
    ...
    public static final String EXEMPT_COOLDOWN_REPLY = "nucleus.message.exempt.cooldown";

    @PermissionMetadata(descriptionKey = "permission.exempt.cost", replacements = { "reply" }, level = SuggestedLevel.ADMIN)
    public static final String EXEMPT_COST_REPLY = "nucleus.message.exempt.cost";

    @PermissionMetadata(descriptionKey = "permission.exempt.warmup", replacements = { "reply" }, level = SuggestedLevel.ADMIN)
    public static final String EXEMPT_WARMUP_REPLY = "nucleus.message.exempt.warmup";
