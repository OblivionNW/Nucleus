...
public class KitPermissions {
    ...
    public static final String BASE_COMMAND_ADD = "nucleus.kit.command.add.base";
    ...
    public static final String BASE_COMMAND_CLEAR = "nucleus.kit.command.remove.base";
    ...
    public static final String EXEMPT_COOLDOWN_KIT_GIVE = "nucleus.kit.give.exempt.cooldown";

    @PermissionMetadata(descriptionKey = "permission.exempt.cost", replacements = { "kit give" }, level = SuggestedLevel.ADMIN)
    public static final String EXEMPT_COST_KIT_GIVE = "nucleus.kit.give.exempt.cost";

    @PermissionMetadata(descriptionKey = "permission.exempt.warmup", replacements = { "kit give" }, level = SuggestedLevel.ADMIN)
    public static final String EXEMPT_WARMUP_KIT_GIVE = "nucleus.kit.give.exempt.warmup";
