...
@NoModifiers
@NonnullByDefault
public class KitHiddenCommand extends KitFallbackBase<CommandSource> {
    ...
    public CommandResult executeCommand(final CommandSource player, CommandContext args, Cause cause) {
        ...
        player.sendMessage(
                Nucleus.getNucleus().getMessageProvider().getTextMessageWithFormat(b ? "command.kit.hidden.off" : "command.kit.hidden.on", kitInfo.getName()));
