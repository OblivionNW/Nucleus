...
public final class FlatFileStorageRepositoryFactory implements IStorageRepositoryFactory<JsonObject> {
    ...
    @Inject public FlatFileStorageRepositoryFactory(@DataDirectory Provider<Path> path) {
        this.dataPath = path;
    }
    ...
    public IStorageRepository.Single<JsonObject> generalRepository() {
        return new FlatFileStorageRepository.Single(() -> this.dataPath.get().resolve("general.json"));
    }
