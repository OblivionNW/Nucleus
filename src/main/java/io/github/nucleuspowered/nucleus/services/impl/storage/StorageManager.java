...
@Singleton
public final class StorageManager implements IStorageManager<JsonObject>, Reloadable {

    private final FlatFileStorageRepositoryFactory flatFileStorageRepositoryFactory;

    @Inject
    StorageManager(@DataDirectory Provider<Path> dataDirectory) {
        this.flatFileStorageRepositoryFactory = new FlatFileStorageRepositoryFactory(dataDirectory);
